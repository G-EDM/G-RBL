...
#define A_STEPS_PER_MM 3840

#define WIRE_SPINDLE_STEPS_PER_MM 153 //
#define WIRE_MIN_SPEED_HZ 16 // MCPWM does not easily allow frequencies below I think 15 hz. Setting such super low frequencies will result in some random stuff going on

extern volatile speeds_mm_min process_speeds_mm_min;

#define WIRE_SPEED_SHORT_CIRCUIT_RPM_UP 1.0 // old; on short circuits the wire can melt to the work and get sticky. This can be a problem
